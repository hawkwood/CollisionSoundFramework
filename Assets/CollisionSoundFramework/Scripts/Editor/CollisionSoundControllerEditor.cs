...
namespace CollisionSoundFramework
{
    ...
    [CustomEditor(typeof(CollisionSoundController))]
    public class CollisionSoundControllerEditor : Editor
    {
        private const string FMODDefine = "CSF_FMOD";
        ...
        private static void DisplayProgressBar(string newMessage = null)
        {
            ...
            EditorUtility.DisplayProgressBar("CollisionSoundFramework", progressBarMessage, UnityEngine.Random.value); // :D
        }
        ...
        {
            CollisionSoundController controller = (CollisionSoundController)target;
            ...
            bool isFMODEnabled = controller.SoundEngine == CollisionSoundProviderType.FMOD;
            bool isUnityEnabled = controller.SoundEngine == CollisionSoundProviderType.Unity;
            bool enableFMOD = controller.SoundEngine == CollisionSoundProviderType.FMOD;
            bool enableUnity = controller.SoundEngine == CollisionSoundProviderType.Unity;
            ...
            if (enableFMOD == false && isFMODEnabled == true)
            {
                ...
                controller.SoundEngine = CollisionSoundProviderType.None;
            }
            else if (enableFMOD == true && isFMODEnabled == false)
            {
                AddDefine(FMODDefine);
                controller.SoundEngine = CollisionSoundProviderType.FMOD;
            }
            ...
            {
                RemoveDefine(FMODDefine);
                controller.SoundEngine = CollisionSoundProviderType.Unity;
            }
